...
const CommentCard = (props) => {
    ...
    console.log("In comment card", props);
        ...
        <div className="w-full">
            <div className="mb-4 flex-col">
                ...
                <p 
                    ...
                    className={`${!isEditing ? "" : "hidden"} muli`}>{props.data.body}</p>
            ...
            <button 
                className={`${isEditing ? "" : "hidden"} bg-cyan-300 text-white text-xs muli w-12 py-1 my-4 rounded`}
