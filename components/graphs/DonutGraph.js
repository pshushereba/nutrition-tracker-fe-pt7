...
const DonutGraph = (props) => {
  ...
  return (
    <CenteredContainer extraClasses={"flex-1"}>
      <h1>The donut nazi has denied me my graph</h1>
    </CenteredContainer>
  )
  // return inBrowser ? (
  //   <HighchartsReact highcharts={Highcharts} options={progressDonut} />
  // ) : (
  //   "not in client"
  // );
