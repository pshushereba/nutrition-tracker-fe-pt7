...
const withApollo = ({
  ...
  if (ssr || PageComponent.getInitialProps) {
    WithApollo.getInitialProps = async ctx => {
      ...
      const apolloClient = initApolloClient(); // Add apolloClient to NextPageContext & NextAppContext
...
const createApolloClient = (initialState = {}) => {
  ...
  return new apollo_client__WEBPACK_IMPORTED_MODULE_4__["ApolloClient"]({
    ...
    link: new apollo_link_http__WEBPACK_IMPORTED_MODULE_6__["HttpLink"]({
    ...
    cache: new apollo_cache_inmemory__WEBPACK_IMPORTED_MODULE_5__["InMemoryCache"]().restore(initialState)
  });
};
